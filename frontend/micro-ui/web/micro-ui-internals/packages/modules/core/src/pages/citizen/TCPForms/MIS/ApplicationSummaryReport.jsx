      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <img
          ...
          <div style={{lineHeight:0, marginLeft:5, marginBottom:15,marginTop:10}}>
            ...
            <h3 className="mis-header"> Application Summary Report</h3>
        ...
        <Table style={{border:"1px solid #000000"}}>
          <TableHead style={{border:"1px solid #000000"}}>
            <TableRow>
              ...
              <TableCell align="left" style={{border:"1px solid #000000"}}>Overdue Cases</TableCell>
              <TableCell align="left" style={{border:"1px solid #000000"}}>Revoked Cases</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {rows.map((row) => (
