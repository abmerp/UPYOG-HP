  ...
  <div className="certificate-container">
    <div className="certificate">
      ...
      <div className="certificate-body" >
        ...
        <div className="body">
          <p>
          You are hereby granted permission under <span style={{fontWeight:500}}>31</span>  of the Himachal Pradesh
          Town and Country Planning Act, 1977 (Act No. 12 of 1977) on Khasra no.
          <span style={{fontWeight:500}}>1604 </span>Revenue Mohal <span style={{fontWeight:500}}>Andora</span> Upper situated at village <span style={{fontWeight:500}}>Andora </span> Upper to
