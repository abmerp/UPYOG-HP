...
import TCPForm11Sign from "../assets/TCPForm11Sign.png";
import QrCode from "./QRCODE";

const Form11TCPCertificate = () => (
    ...
    <div className="certificate">
      ...
      <img
        ...
        <p className="certificate-title">
          ...
          <h1 className="border-title">Permission For Developement/ Subdivision Of Land</h1>
        </p>
        <div>
      ...
      <div className="certificate-date">
        ...
        <div className="name">
          ...
          Mr. Tara Dutt Sharma&nbsp;&nbsp;&nbsp;&nbsp;<span style={{fontWeight:"400"}}>C/o:</span>S/o Chaman Lal
          Village Dhar,p.o. Mashobra Shimla, , Saruila Baruila, Shimla(Rural), Shimla, Himachal Pradesh
          </span>
        </div>
        ...
        <span style={{marginLeft:10,fontSize:15,fontWeight:"400"}}>Application of permission Development/ Subdivision of land.</span>
         ...
         Your application No. <span style={{fontWeight:700}}>01202000270</span>,&nbsp;&nbsp;&nbsp;&nbsp;Dated. <span style={{fontWeight:700}}>15-Jul-2020</span>
          </span>
        </div>
        <div className="body1">
          <p>
        You are hereby granted permission under <span style={{fontWeight:500}}>16(C)</span> of the Himachal Pradesh Town and Country Planning Act, 1977
(Act No. 12 of 1977) for subdivision of land on Khasra no.  <span style={{fontWeight:500}}>278/1</span> Mohal <span style={{fontWeight:500}}>Saruila Baruila</span> situated at village<span style={{fontWeight:500}}> Saruila
Baruila</span>, District <span style={{fontWeight:500}}>Shimla </span>Himachal Pradesh subject to the following conditions:-
</p>
<p>
1. The subdivision of plots shall be done strictly in accordance with the enclosed plan. Before selling the plots, the sub division approved shall be incorporated in revenue record.
</p>
<p>
...
interest ,falling within the limits of Town and Country Planning areas</p>
        </div>
        ...
        <div className="certificate-last">
          ...
          <img src={TCPForm11Sign} alt="" className="sign" />
        </div>
      </div>
    </div>
  </div>
...
export default Form11TCPCertificate;
