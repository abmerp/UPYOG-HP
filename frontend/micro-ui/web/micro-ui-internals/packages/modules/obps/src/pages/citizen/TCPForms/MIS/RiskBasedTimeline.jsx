...
export default function RiskBasedTimeline() {
  ...
  return (
    ...
    <div className="mis">
     ...
     <div> <h6 className="mis-header">Risk Based Timeline Report </h6>
     <span style={{marginTop:"10px",marginLeft:"68%",marginRight:"5px"}}><label style={{marginRight:"2px"}}>Search:</label><input/></span>
     <span><button className="btnstyle2"><PictureAsPdfIcon color="success" fontSize="small"/>Pdf</button>
