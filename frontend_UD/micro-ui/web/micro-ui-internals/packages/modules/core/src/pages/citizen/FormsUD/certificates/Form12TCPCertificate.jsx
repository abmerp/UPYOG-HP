    ...
    <div className="certificate">
      ...
      <div className="certificate-body" >
        ...
        <div className="certificate-date">
          ...
          <h2>No. : 02202101745</h2>
          <h2>Dated : 28/Jan/2022</h2>
        </div>
        ...
        <div className="name">
          ...
          Mr. Manju&nbsp;&nbsp;<span style={{fontWeight:"400"}}>C/o:</span>D/o Chetram
          Village & P.O. Shalgada Tehsil & District Shimla,Shalgada, Shimla(Rural), Shimla, Himachal Pradesh
          </span>
        </div>
       
        <div style={{fontSize:15,float:"left",fontWeight:"700",marginLeft:10}}>
          Subject :-
        <span style={{marginLeft:10,fontSize:15,fontWeight:"400"}}>Permission for Development / Construction of building.
          </span>
          </div>
     
        <div className="body">
          <p>
        You are hereby granted permission under section <span style={{fontWeight:500}}>31-1(b)</span> of the Himachal Pradesh Town and Country Planning
Act, 1977 (Act No. 12 of 1977) on Khasra no.<span style={{fontWeight:500}}> 665 </span> Revenue Mohal <span style={{fontWeight:500}}> Ghandal</span> situated at village<span style={{fontWeight:500}}> Ghandal</span> to carry out the
development/ sub-division of land/ construction of building as mentioned in your Application under reference, subject to
...
15. The applicant shall sole responsible if any dispute raised in future regarding land boundary
</p> 
        </div>
...
export default Form12TCPCertificate;
