...
const Form26Calculator = ()=>{
    ...
    return (
        ...
        <div>
            <Box>
            <h3 style={{width:'100%', backgroundColor:'#F1F1F1', height:'30px'}}>Offences/Deviation Details</h3>
       <Box display='flex' flexDirection='row'>
            ...
            <Grid item xs={3}>
                <Typography variant="body2">Deviation Category:</Typography>
            </Grid>
            <Grid item xs={3}>
                <Select
...
export default Form26Calculator;
